...
neutral = [
    ...
    "How do you generate a random string? Ask a first year CS student to use VIM and to save and exit.",
    "I've been using vim for a long time now, mainly because I can't figure out how to exit.",
    "How do you know whether a person is a vim user? They'll tell you themselves.",
    "[a person is choking] waiter: Quick is anyone a doctor? vim user: I’m a vim user.",
]
